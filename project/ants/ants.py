        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                if insect.can_contain(self.ant):
                    ...
                    self.ant = insect
                assert not self.ant.can_contain(insect) or not insect.can_contain(self.ant), "what the fuck"
                # END Problem 9
        else:
...
class Ant(Insect):
    ...
    food_cost = 0  # class attribute can override by subclass
    ...
    def __init__(self, armor=1):
        ...
        Insect.__init__(self, armor)  # instance attribute
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while cur_place != hive:
            if cur_place.bees and (self.min_range <= index <= self.max_range):
...
class BodyguardAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 9
        "*** YOUR CODE HERE ***"
        return self.contain_ant is None and other.is_container is False
        # END Problem 9
    ...
    def action(self, colony):
        ...
        if self.contained_ant:
            self.contained_ant.anction(colony);
        # END Problem 9
